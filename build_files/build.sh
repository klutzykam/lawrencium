...
pacman -Syu bash bash-completion curl gcc nano tar unzip nvidia-open nvidia-utils efibootmgr plasma plasma-login-manager konsole dolphin pipewire wireplumber chaotic-aur/opentabletdriver flatpak --noconfirm
