...
pacman -Syu bash bash-completion curl gcc nano tar unzip efibootmgr plasma plasma-login-manager konsole dolphin pipewire wireplumber chaotic-aur/opentabletdriver flatpak lvm2 tpm2-tss nvidia nvidia-utils --noconfirm
